...
public class OrderServiceTest {
    ...
    public void 주문취소() {
        ...
        Long orderId = orderService.order(member.getId(), item.getId(), orderCount); //주문한것 까지 들어가는게 맞다.
        ...
        assertEquals("주문 취소시 상태는 CANCEL이 된다", OrderStatus.CANCEL, getOrder.getStatus());
